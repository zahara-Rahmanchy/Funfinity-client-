...
const Gallery = () => {
  return (
    <div className="max-w-6xl mx-auto bg-purple-400 px-6 py-3 mt-10 shadow-xl shadow-slate-500 border-slate-200 border-4">
      <div className=" w-full grid grid-cols-3 my-10 gap-5">
        ...
        <img src="https://img.freepik.com/premium-vector/sudoku-game-vector-set-japanese-puzzle-game_182787-502.jpg?w=740" />
        <img src="https://img.freepik.com/free-vector/business-game-success-competition-board-game-businessman-concept-strategy-idea-teamwork-play_1284-41346.jpg?w=740&t=st=1684561192~exp=1684561792~hmac=fb2359df562abbb4ba11783e175105813c92b323a49af1f63b3658f74e96093b" />
        <img src="https://img.freepik.com/free-photo/alphabet-with-dice-wooden-board_23-2148101542.jpg?w=740&t=st=1684560969~exp=1684561569~hmac=33ba748e019fbed55ccd288af45afe5df9ad2b0e00e35952be3d5102c49a14bd" />
      </div>
    </div>
  );
};
